                    ...
                    <form>
                        ...
                        <fieldset className="form-control w-80">
                            <label className="label">
                                <span className="label-text text-white font-medium font-inter">Enter your email address</span>
                            </label>
                            <div className="join">
                                <input type="text" placeholder="username@site.com" className="input input-bordered text-black join-item" />
                                <button className="btn font-inter border-none bg-blue-500 text-white join-item">Subscribe</button>
                            </div>
                        </fieldset>
                    </form>
                </div>
            </div>
            <div className="py-6 text-sm text-center dark:text-gray-600">©2025 AllShop. All rights reserved.</div>
        </footer>
    );
};
