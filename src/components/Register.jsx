        ...
        <div className="hero bg-gray-400 min-h-screen">
            <div className="hero-content justify-between p-10 border border-white bg-blue-400 rounded-lg text-white flex-col lg:flex-row">
                <div className="text-center space-y-5 w-1/2 lg:text-left">
                    ...
                    <p>
                        Best place to explore and fulfill your desires. We have a large collection of items. Anytime, anywhere, we will deliver your item with pleasure.
                    </p>
                </div>
                <div className="card w-full max-w-sm bg-blue-400 border shadow-white shadow-xl">
                    <form onSubmit={handleSubmit(onSubmit)} className="card-body">
                        <div className="space-y-3 rounded-xl dark:text-gray-800">
                            <h1 className="text-2xl font-bold text-center">Register</h1>
                            <div className="space-y-1 text-sm">
                                <label htmlFor="name" className="block font-medium text-white">Name</label>
                                <input {...register('name')} type="text" id="name" placeholder="Write your name" className="w-full px-4 py-3 rounded-md dark:border-gray-300 text-gray-800 focus:dark:border-default-600" />
                            </div>
                            <div className="space-y-1 text-sm">
                            ...
                            <div className="space-y-1 text-sm relative">
                                ...
                                {showPassword ? (
                                    <svg
                                        ...
                                        className="absolute bottom-3 right-2 h-6 w-6 cursor-pointer text-black"
                                        fill="none"
                                        viewBox="0 0 24 24"
                                        stroke="currentColor"
                                        strokeWidth="1.5"
                        ...
                        <div className="flex items-center pt-4 space-x-1">
                            ...
                            <p className="px-3 text-center text-sm font-medium text-white">Register with social account</p>
                            <div className="flex-1 h-px sm:w-16 dark:bg-gray-300"></div>
                        </div>
